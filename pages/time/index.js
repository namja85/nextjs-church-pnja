...
export default function Hello() {
  return (
    <div className="container p-4">
      <Head>
        <title>예배시간안내 | 평내중앙교회</title>
        <meta
          name="description"
          content="평내중앙교회 예배시간을 안내합니다."
        />
      </Head>
      ...
      <div className="space-y-4">
        ...
        <h2 className="text-center text-md">
          <span className="font-bold mr-2">요4:23</span>아버지께 참되게 예배하는 자들은 영과 진리로 예배할 때가 오나니 곧 이 때라 아버지께서는 자기에게 이렇게 예배하는 자들을 찾으시느니라
        </h2>
      </div>
