...
export default function Hello() {
  return (
    <div className="container p-4">
      <Head>
        <title>인사말 | 평내중앙교회</title>
        <meta
          name="description"
          content="안녕하세요. 평내중앙교회 담임목사 김명호입니다."
        />
      </Head>
      ...
      <div className="space-y-4">
        ...
        <h2 className="text-center text-xl font-bold">
          &quot;세계선교를 통한 인재양성, 금융권을 통한 선교, 학원가를 통한 선교!&quot;
        </h2>
      </div>
      ...
      <div className="text-lg px-4 sm:px-0 my-16 flex flex-col justify-center text-center space-y-4">
        ...
        <p className="!mt-16 text-lg space-x-4"><span className="font-bold">담임목사</span><span>김명호</span></p>
      </div>
    </div>
  );
}
